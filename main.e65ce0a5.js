...
var La = NewWordList,
  ...
  // This is what chooses the solution.,
    ...
    var Za = "IN_PROGRESS",
        es = "WIN",
        as = "FAIL",
        ss = ["Get fucked, you cheated", "No one cares about your score", "Get fucked", "Much better than Brian", "Meh", "Shitty, but still better than Brian"],
        ts = function(e) {
            r(t, e);
            var a = h(t);
