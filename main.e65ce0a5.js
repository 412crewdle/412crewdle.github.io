...
var La = NewWordList,
    ...
    var Ha = new Date(2022, 1, 5, 0, 0, 0, 0);
  ...
  // This is what chooses the solution.,
    function Da(e) {
        var a, s = Ga(e);
    ...
    $s.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Guess the <strong>CREWDLE</strong> in 6 tries. This is like Wordle, but lamer.</p>\n      <p>All words allowed in Wordle are allowed as guesses. However, in Crewdle, we encourage you to use names or phrases from our group\’s bullshit, which will ultimately be the answer. Just to clarify, the correct answer will only be from our bullshit, and Brian still sucks.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="b" evaluation="correct" reveal></game-tile>\n            <game-tile letter="r"></game-tile>\n            <game-tile letter="i"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="n"></game-tile>\n          </div>\n          <p>The letter <strong>B</strong> is in the word and in the correct spot. However, Brian is still a loser.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="s"></game-tile>\n            <game-tile letter="u" evaluation="present" reveal></game-tile>\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="k"></game-tile>\n            <game-tile letter="s"></game-tile>\n          </div>\n          <p>The letter <strong>U</strong> is in the word but in the wrong spot. But <strong>U</strong> still suck Brian.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="b"></game-tile>\n            <game-tile letter="u"></game-tile>\n            <game-tile letter="t"></game-tile>\n            <game-tile letter="t"></game-tile>\n            <game-tile letter="s" evaluation="absent" reveal></game-tile>\n          </div>\n          <p>The letter <strong>S</strong> is not in the word in any spot. So <strong>S</strong>uck it Brian.</p>\n        </div>\n      </div>\n      <p><strong>A new CREWDLE will be available each day!<strong></p>\n    </div>\n  </section>\n';
    var Hs = function(e) {
        r(t, e);
        var a = h(t);
